...
<div class="p-4 sm:ml-64">
   <div class="p-4 mt-14">
      ...
      <div class="border-2 rounded-lg border-gray-100 mt-5 shadow-lg">
         ...
         <form action="#" method="post" class="px-5 py-5 gap-2">
            ...
            <div class="flex flex-row justify-between items-center gap-4 sm:gap-6 sm:col-span-2">
               ...
               <div class="w-full">
                  ...
                  <input type="number" name="weight" id="weight" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"  required>
               </div>
               <div class="w-full">
                  <label for="size" class="block mb-2 text-sm font-medium text-gray-900">Estatura (cm)</label>
                  <input type="number" name="size" id="size" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"  required>
               </div>
            </div>
