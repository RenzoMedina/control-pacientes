                    ...
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <?php foreach($users as $usuario): ?>
                            ...
                            <tr class="border-b border-gray-700">
                                ...
                                <td class="px-4 py-3"><?php echo ucwords($usuario['name'])?></td>
                                <td class="px-4 py-3"><?php echo ucwords($usuario['last_name'])?></td>
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="<?php echo $usuario['id']."-dropdown-button"?>"
                                        data-dropdown-toggle="<?php echo $usuario['id']."-dropdown"?>"
                                    ...
                                    <div id="<?php echo $usuario['id']."-dropdown"?>"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            aria-labelledby="apple-imac-27-dropdown-button">
                                            <li>
                                                <a href="/home/users/<?php echo $usuario['id'] ?>"
